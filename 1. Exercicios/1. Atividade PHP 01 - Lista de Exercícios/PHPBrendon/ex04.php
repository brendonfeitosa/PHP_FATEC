...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($num > 0) {
        $msg = "<div class='alert alert-success' role='alert'>O número [$num] é positivo.</div>";
    } elseif ($num == 0) {
        $msg = "<div class='alert alert-success' role='alert'>O número [$num] é igual a zero.</div>";
    } else {
        $msg = "<div class='alert alert-danger' role='alert'>O número [$num] é negativo.</div>";
    }
}
?>
<!doctype html>
